...
async def scan_major_retailer(
    ...
    *,
    ...
    Step 6K-1A validates and normalizes retailer output only. It does not
    ...
    return {
        ...
        "note": "6K-1A validates adapter output only; persistence and Discord events remain disabled.",
    }
