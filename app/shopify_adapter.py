...
r"gift\scollection|"
r"double\spack|"
r"premium\scollection|"
r"special\scollection|"
r"elite\strainer\sbox|"
r"etb|"
r"blister|"
r"case|"
r"tin"
...
r"\b(?:"
r"(?|EB|PRB|ST|EX)\s*-?\s*\d{1,2}\s*-\s*\d{3}"
r"|"
r"P\s*-?\s*\d{3}"
r")\b",
re.IGNORECASE,
...
r"\b(?\sart|alternate\sart|alt\sart|parallel|foil|holo|"
r"secret\srare|super\srare|leader\sparallel|manga\s*rare)\b",
re.IGNORECASE,
)
...
def init(self, status, message, *, url=None, purpose=None):
super().init(message)
self.status = status
self.url = url
