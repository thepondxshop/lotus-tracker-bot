...
class LotusTrackerBot(
    ...
    async def setup_hook(self):
        ...
        # Persistent selector survives restarts
        self.add_view(
...
async def games(
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "Run `/games` anytime to change your selections."
        )
    )
    ...
    try:
        ...
        if not permissions.embed_links:
            ...
            await interaction.followup.send(
                ...
                "❌ Lotus Tracker Bot needs **Embed Links** in `#roles`.",
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "Return here anytime to update your selections."
            )
        )
...
async def settings(
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "This is your current Discord-side configuration.\n\n"

            "More detailed personal alert preferences will be added "
            "when the database system comes online."
        )
    )
